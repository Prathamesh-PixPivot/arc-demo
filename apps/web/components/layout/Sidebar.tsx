...
export function Sidebar({ collapsed, onCollapse }: SidebarProps) {
    ...
    const navItems = user?.type === 'user' ? navigationItems.user : navigationItems.fiduciary;
            ...
            <div className="flex items-center h-16 px-4 border-b border-gray-200">
                {!collapsed && (
                    <Link href="/dashboard" className="flex items-center space-x-2">
                        ...
                        <span className="font-semibold text-gray-900">Arc Privacy</span>
                    </Link>
                )}

                <button
                    onClick={() => onCollapse(!collapsed)}
                    className="ml-auto p-2 hover:bg-gray-100 rounded-lg focus-ring"
                ...
                {navItems.map((item) => {
                    ...
                    return (
                        <Link
                            ...
                            href={item.href}
                            className={cn(
                                'flex items-center px-3 py-2 rounded-lg text-sm font-medium transition-colors focus-ring',
                                isActive
